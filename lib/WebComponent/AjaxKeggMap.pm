...
sub setup {
	...
	my $keggdata = ModelSEED::FIGMODEL::FIGMODELTable::load_table($self->application->data_handle('FIGMODEL')->config("database root directory")->[0]."ReactionDB/masterfiles/MapDataTable.txt",";","|",0,undef);
