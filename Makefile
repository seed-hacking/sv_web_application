...
cp-html: 
	...
	rsync -arv lib/WebComponent/js/* $(TOP_DIR)/html
	rsync -arv lib/WebComponent/css/* $(TOP_DIR)/html
	rsync -arv lib/WebComponent/images/* $(TOP_DIR)/html
...
deploy-service: deploy-libs deploy-scripts deploy-cgi-scripts deploy-docs deploy-html
